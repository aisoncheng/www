...
;layui.define("layer", function(e) {
    ...
    ,
    //modify
    u.prototype.attr = function(a,ops){
    	  a.find("form").attr(ops);
    	  return this;
    },
    //modify
    u.prototype.action = function(a,action){
    	  a.find("form").attr('data-action',action);
    	  return this;
    },
    //modify
    u.prototype.fill = function(a,ops){
    	  
    	  a.find("form *[name]").each(function(){
				$(this).val(ops[this.name]);
				var node = this.nodeName;
				if(node == 'INPUT'&&$.trim($(this).val())){
					var type = $(this).attr("type"),
						parent =$(this).attr('data-parent'),
						refType=$(this).attr('data-refType');
					if(refType&&refType=='checkbox'){
						$(this).parents(parent).find("input[type='checkbox']").attr("checked","checked");
					}
				}
		 });
    	 this.render();
   ...
   //modify
    u.prototype.reset = function(a){
    	  var af = a.find("form");
    	  af[0].reset();
    	  af.find("input[type='hidden']").each(function(){
    		  i(this).val('');
    	  });
    	  this.render();
    	  return this;
        ...
        var a = this
          , n = {
            select: function() {
                var e = "请选择"
                  ...
                  , o = function(e, n) {
                    ...
                    n || (o.on("click", function(i) {
                        e.hasClass(a + "ed") ? e.removeClass(a + "ed") : (u(i, !0),
                        e.addClass(a + "ed"))
                    }),
                    e.find("dl>dd").on("click", function() {
                        var e = i(this)
                          , a = e.attr("lay-value")
                          , t = s.attr("lay-filter");
                        return !e.hasClass(r) && (s.val(a).removeClass("layui-form-danger"),
                ...
                n.each(function(n, l) {
                	var s = i(this);
                	var layoff = s.attr("lay-off");
                	if(layoff=='true'){
                		s.show();
                		s.css({"vertical-align":"middle","cursor":"pointer"});
                	}else{
                		 var u = s.next("." + a)
                         , d = this.disabled
                         , f = l.value
            ...
            checkbox: function() {
                var e = {
                  ...
                  , t = function(e, a) {
                    ...
                    e.on("click", function() {
                        ...
                        t[0].disabled || (t[0].checked ? (t[0].checked = !1,
                        e.removeClass(a[1])) : (t[0].checked = !0,
                        e.addClass(a[1])),
                        layui.event(l, a[2] + "(" + i + ")", {
                            elem: t[0],
                            value: t[0].value
                ...
                a.each(function(a, n) {
                	var l = i(this);
                	var layoff = l.attr("lay-off");
                	if(layoff=='true'){
                		l.show();
                		l.css({"vertical-align":"middle","cursor":"pointer"});
                	}else{
                		var s = l.attr("lay-skin")
                        , c = this.disabled;
                      "switch" === s && (s = "_" + s);
