...
;!function(e, t) {
    ...
    l.pt.creat = function() {
        ...
        if (!i("#" + t.id)[0]) {
            ...
            case 2:
                ...
                t.content = '<iframe scrolling="' + (t.content[1] || "auto") + '" allowtransparency="true" id="' + s[4] + a + '" name="' + s[4] + a + '" onload="this.className=\'\';" class="layui-layer-load" frameborder="0" src="' + t.content[0] +(t.sendId?"?iframeId="+(s[4] + a)+"":"") +'"></iframe>';
                break;
            case 3:
                delete t.title,
                delete t.closeBtn,
    ...
    //modify
    r.get = function(e) {
    	return  i("#layui-layer"+e);
    };
    //modify
    r.topThis = function(e){
		 this.zIndex++;
		 if(!isNaN(e)){
			 e = r.get(e);
		 }
		 e.css("z-index", this.zIndex + 1); 
		 return  this.zIndex
	};
    var f = r.cache || {}
      , c = function(e) {
