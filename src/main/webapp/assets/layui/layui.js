...
;!function(e) {
    ...
    t.fn.use = function(e, t, a) {
        ...
        !v.attachEvent || v.attachEvent.toString && v.attachEvent.toString().indexOf("[native code") < 0 || u ? v.addEventListener("load", function(e) {
            s(e, h)
...
layui.config({
	dir:"/mvc/assets/layui/",
	base:"/mvc/assets/js/"
})

layui.useMine = function(m,ndir,c){
	if(ndir){
		var op = {};
		op[m] = ndir;
		layui.extend(op);
